...
if __name__ == '__main__':
    ...
    f = open(CONFIGS.TEST_DATA_FILES[0])
    # f = open(f'/data/ylw/code/pl_yolo/data/yolov1/voc_test.txt')
    lines = f.readlines()
    file_list = []
    for line in lines:
    ...
    model_file = os.path.join(CONFIGS.CHECKPOINT_DIR, '20.pth')
    ...
    for image_path in tqdm(image_list):
        result = predict_gpu(model,image_path,root_path=CONFIGS.DATASET_DIRS[0]) #result[[left_up,right_bottom,class_name,image_path],]
